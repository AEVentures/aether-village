...
const phases = [
  ...
  ['02', 'Open Ai Castle', 'Launch legal founder residencies and curated company retreats using the existing estate.'],
...
export function App() {
  ...
  return <div className='site-shell fairytale'>
    <header className="nav"><a className="brand" href="#top" aria-label="Aether Village home"><span>Æ</span><div>AETHER <small>VILLAGE</small></div></a><nav aria-label="Primary navigation"><a href='#vision'>Vision</a><a href='#showcase'>Place</a><a href='#plan'>Plan</a><a href="#apply">Apply</a></nav><a className="nav-cta" href="#apply">Join the founding circle <ArrowRight size={16}/></a></header>
    ...
    <main id="top">
      <section className='hero-section'><img className='hero-photo' src='images/estate-1.webp' alt='Ai Castle at sunset over the 68-acre grounds' loading='eager' decoding='async' />
        ...
        <div className="hero-content"><p className="eyebrow"><Sparkles size={15}/> A fairytale AI village · Oregon</p><h1>Build the future.<br/><em>Live differently.</em></h1><p className="hero-copy">A 68-acre fairytale château where AI founders live, build, and break bread together. Imagine symposiums by the fire, code sprints at sunrise, and orange capsule pods glowing under Oregon stars.</p><div className="hero-actions"><a className="button primary" href="#apply">Apply to join <ArrowRight size={18}/></a><a className="button ghost" href="#plan">Explore the plan <ChevronDown size={18}/></a></div><p className="fine-print">Feasibility-stage concept · No deposits or investment solicitation</p></div>
